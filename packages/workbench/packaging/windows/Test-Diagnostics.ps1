...
try {
    ...
    [ordered]@{ product='FORGE Workbench'; version='0.2.0-rc.5'; sourceCommit=$secret } | ConvertTo-Json | Set-Content -LiteralPath (Join-Path $installRoot 'RELEASE.json') -Encoding utf8
    [ordered]@{
